...
> [!IMPORTANT]
> **Доступен свежий релиз v2.1.0!**  
> Вы можете скачать готовый скомпилированный файл **`ShortcutDock.exe`** на странице [Релизы](https://github.com/Almanex/ShortcutDock/releases/tag/v2.1.0) и запустить его на своем компьютере без установки дополнительных библиотек.
