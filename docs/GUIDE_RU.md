...
Добавить новые программы, папки или диски на панель можно тремя основными способами:

### Способ А: Простое перетаскивание (Drag-and-Drop)
* **Файлы, папки и диски:** Просто перетащите любой исполняемый файл (`.exe`), ярлык (`.lnk`), папку или жесткий диск из Проводника Windows на свободное место панели.
* **Перетаскивание из меню «Пуск»:** Вы можете перетаскивать ярлыки приложений напрямую из меню «Пуск» (включая UWP-приложения и игры из Microsoft Store). ShortcutDock автоматически распознает их системный идентификатор AUMID (App User Model ID) и создаст рабочий ярлык.

### Способ Б: Через кнопку «+»
1. Кликните по значку `+` на панели (если он включен в настройках).
2. В диалоговом окне выберите программу или ярлык и нажмите «Открыть».

### Способ В: Через контекстное меню панели
* Кликните правой кнопкой мыши по пустому пространству панели. Вам доступны следующие пункты:
  * **«Добавить файл или программу...»** — открывает стандартный выбор файла.
  * **«Открыть окно всех приложений (Microsoft Store & Win32)...»** — открывает системную виртуальную папку `shell:AppsFolder` со всеми установленными в системе приложениями (как классическими, так и из Microsoft Store). Вы можете перетаскивать значки прямо оттуда на панель ShortcutDock.
...
* Кликните ПКМ по ярлыку на панели и выберите **«Открыть расположение файла»**, чтобы мгновенно открыть целевую папку в Проводнике Windows с выделенным файлом.
...
### Веер папок (Folder Stacks)
* При добавлении на панель папки (например, *«Загрузки»* или *«Документы»*), клик по ней открывает стильное всплывающее меню-веер с элементами папки. Любой файл можно открыть в один клик прямо из веера или перейти в полноценный Проводник кнопкой **«Открыть в Проводнике»**.
...
* **Прозрачность фона веера папок:**
  * Удобный ползунок плавной регулировки прозрачности всплывающего веера папок (от 30% до 100%).
