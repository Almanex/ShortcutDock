...
* **Эффект размытия:**
  ...
  * *Mica:* Фирменный полупрозрачный эффект Windows 11, подстраивающийся под цвет обоев.
  * *Acrylic:* Эффект матового полупрозрачного стекла.
* **Размер значков:**
...
* **Показывать кнопку «+» на панели:**
  * Позволяет скрыть кнопку добавления на док-панели для создания чистого и минималистичного вида.
